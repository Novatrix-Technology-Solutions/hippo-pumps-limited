...
export default function Edit({ solution, categories }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        title: solution.title,
        description: solution.description,
        category: solution.category,
        q_max: solution.q_max,
        h_max: solution.h_max,
        rated_q: solution.rated_q,
        rated_h: solution.rated_h,
        motor: solution.motor,
        price_zmw: solution.price_zmw,
        vat_rate: solution.vat_rate,
        net_price_zmw: solution.net_price_zmw,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.pump-solutions.update', solution.id));
    };
                ...
                <div className="md:grid md:grid-cols-3 md:gap-6">
                    <div className="md:col-span-1">
                        <div className="px-4 sm:px-0">
                            <h3 className="text-lg font-medium leading-6 text-gray-900">Edit Pump Solution</h3>
                            <p className="mt-1 text-sm text-gray-600">
                                Update the details for the pump solution.
                            </p>
                        </div>
                    </div>
